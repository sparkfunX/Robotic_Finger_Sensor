/*
  ...
  This example outputs the pressure values so the plotter can show them.
  Open the 'Serial Plotter' at 9600bps and you should see the graph of pressure.
  Please the sensor flat on a desk and press down on the top to see the values cahgen.
